...
- [ ] Build configured stock/period selection, charts, comparison metrics, a cited report, and evidence-grounded follow-up chat.
  ...
  - [ ] Live-verify the first deployed `Run Research` action end to end through the app service, Databricks-native transport, controlled Gold access, AI Search, GPT OSS workers, Supervisor synthesis, and bounded callback result metadata before starting presentation-layer rendering.
