...
**Next:** Enrich the Evidence tab with publication-safe citation metadata and source links, then enable session-bound grounded follow-up chat over the active validated research session.
...
- [ ] Build configured stock/period selection, charts, comparison metrics, a cited report, and evidence-grounded follow-up chat.
  ...
  - [ ] Render the validated cited report and evidence/provenance views.
    ...
    - [ ] Re-run worker/runtime/presenter/shell gates, redeploy, and live-check AAPL plus AAPL/MSFT Evidence tabs before closing the evidence/provenance view.
