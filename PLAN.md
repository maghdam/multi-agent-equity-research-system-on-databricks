...
**Next:** Complete application logging/monitoring/feedback and secure-runtime verification, then enforce the portfolio publication boundary and finish screenshots/demo/reproduction evidence for the final delivery gate.
...
- [ ] Add application logging, monitoring, feedback collection, and secure secret handling.
  ...
  - [ ] Run the focused observability/app regression gates, redeploy, exercise research + follow-up + one feedback rating, and verify bounded `APP_EVENT` lines from Databricks App logs before closing the operations slice.
