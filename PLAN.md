...
**Next:** Offline-verify and deploy the controlled normalized price-history chart slice, then live-check single-company and comparison charts before enriching evidence metadata and enabling session-bound follow-up chat.
...
- [ ] Build configured stock/period selection, charts, comparison metrics, a cited report, and evidence-grounded follow-up chat.
  ...
  - [ ] Render Overview/Market/Fundamentals from controlled data with exact as-of/status semantics and comparison-safe charts/tables.
    ...
    - [ ] Offline-verify the chart adapter/runtime/presenter/shell tests and bundle validation, then deploy and live-check AAPL and AAPL/MSFT charts.
