...
- [ ] Add screenshots, example output, a short demo, and concise reproduction instructions covering CI, authentication, release checks, and redeploying a known-good version.
  ...
  - [ ] Capture and commit the final reviewed screenshot set under `docs/screenshots/`, then link the strongest two or three images from README/demo documentation. The required portfolio set now includes the app comparison overview, normalized market chart, validated report, evidence provenance, grounded follow-up, a Databricks Catalog view proving the Bronze/Silver/Gold/AI-RAG assets, and a four-part readable screenshot set for the final managed MLflow E1/E2 metrics table; scope-refusal and APP_EVENT screenshots are optional supporting evidence.
