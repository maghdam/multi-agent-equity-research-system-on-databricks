...
**Next:** Enable session-bound grounded follow-up chat over the active validated research session, then complete application logging/monitoring/feedback and the final portfolio delivery gate.
...
- [ ] Build configured stock/period selection, charts, comparison metrics, a cited report, and evidence-grounded follow-up chat.
  ...
  - [ ] Add session-bound evidence-grounded follow-up chat over the active validated research context.
    ...
    - [ ] Run the focused follow-up/app regression gates, redeploy, and live-check at least one grounded factual question, one provenance question, one second-turn contextual question, and one out-of-context/prompt-injection-style question before closing follow-up chat.
